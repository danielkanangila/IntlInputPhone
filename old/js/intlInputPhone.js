...
(function($) {
    ...
    var IntlInputPhone = function(element, options) {
        ...
        this.preferred_country = typeof options.preferred_country != 'undefined' ? options.preferred_country : ['fr', 'us']
        this.display_error = typeof options.display_error != 'undefined' ? options.display_error : 'on'
        this.error_message = typeof options.error_message != 'undefined' ? options.error_message : IntlInputPhone.DEFAULTS.error_message
    }

    IntlInputPhone.VERSION = 'v1.0'
            ...
            $.each($this.preferred_country, function(k, v) {
                if (v.toUpperCase() == value.cca2) {
                    var c = $this.arrayToKeysValues(value).keys,
                        d = $.map(value, function(vl, ix) { if (ix == 'cca2') return vl.toLowerCase();
                            else return vl; });
                    pc += IntlInputPhone.DEFAULTS.item.format(c, d);
                }
            })
            var a = $this.arrayToKeysValues(value).keys,
                b = $.map(value, function(vl, ix) { if (ix == 'cca2') return vl.toLowerCase();
                    else return vl; });
            cs += IntlInputPhone.DEFAULTS.item.format(a, b);
        })
        if (pc.length > 0) { items += pc;
    ...
    IntlInputPhone.prototype.validate = function(el) {
        ...
        if (typeof r == 'object') {
            ...
            if ($('.intlInputPhone').length > 0) { $('.intlInputPhone').remove();
                $('.input-group').append(h); } else { $('.input-group').append(h); }
        } else { $('.intlInputPhone').remove();
            this.showError(el, this.getErrorMessage(r)); return false; }
    }
...
function(t) { "use strict"; var e = t.fn.jquery.split(" ")[0].split("."); if (e[0] < 2 && e[1] < 9 || 1 == e[0] && 9 == e[1] && e[2] < 1 || e[0] > 2) throw new Error("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher, but lower than version 3") }(jQuery), + function(t) { "use strict";
    ...
    function o(o) { o && 3 === o.which || (t(n).remove(), t(r).each(function() { var i = t(this),
                n = e(i),
    ...
    function i(e) { return this.each(function() { var o = t(this),
            ...
            i || o.data("bs.dropdown", i = new s(this)), "string" == typeof e && i[e].call(o) }) } var n = ".dropdown-backdrop",
        r = '[data-toggle="dropdown"]',
        s = function(e) { t(e).on("click.bs.dropdown", this.toggle) };
    s.VERSION = "3.3.6", s.prototype.toggle = function(i) { var n = t(this); if (!n.is(".disabled, :disabled")) { var r = e(n),
                s = r.hasClass("open"); if (o(), !s) { "ontouchstart" in document.documentElement && !r.closest(".navbar-nav").length && t(document.createElement("div")).addClass("dropdown-backdrop").insertAfter(t(this)).on("click", o); var a = { relatedTarget: this }; if (r.trigger(i = t.Event("show.bs.dropdown", a)), i.isDefaultPrevented()) return;
                n.trigger("focus").attr("aria-expanded", "true"), r.toggleClass("open").trigger(t.Event("shown.bs.dropdown", a)) } return !1 } }, s.prototype.keydown = function(o) { if (/(38|40|27|32)/.test(o.which) && !/input|textarea/i.test(o.target.tagName)) { var i = t(this); if (o.preventDefault(), o.stopPropagation(), !i.is(".disabled, :disabled")) { var n = e(i),
                    s = n.hasClass("open"); if (!s && 27 != o.which || s && 27 == o.which) return 27 == o.which && n.find(r).trigger("focus"), i.trigger("click"); var a = " li:not(.disabled):visible a",
                    p = n.find(".dropdown-menu" + a); if (p.length) { var l = p.index(o.target);
                    38 == o.which && l > 0 && l--, 40 == o.which && l < p.length - 1 && l++, ~l || (l = 0), p.eq(l).trigger("focus") } } } }; var a = t.fn.dropdown;
    t.fn.dropdown = i, t.fn.dropdown.Constructor = s, t.fn.dropdown.noConflict = function() { return t.fn.dropdown = a, this }, t(document).on("click.bs.dropdown.data-api", o).on("click.bs.dropdown.data-api", ".dropdown form", function(t) { t.stopPropagation() }).on("click.bs.dropdown.data-api", r, s.prototype.toggle).on("keydown.bs.dropdown.data-api", r, s.prototype.keydown).on("keydown.bs.dropdown.data-api", ".dropdown-menu", s.prototype.keydown) }(jQuery), + function(t) { "use strict";

    function e(e) { return this.each(function() { var i = t(this),
                n = i.data("bs.tooltip"),
                r = "object" == typeof e && e;
            (n || !/destroy|hide/.test(e)) && (n || i.data("bs.tooltip", n = new o(this, r)), "string" == typeof e && n[e]()) }) } var o = function(t, e) { this.type = null, this.options = null, this.enabled = null, this.timeout = null, this.hoverState = null, this.$element = null, this.inState = null, this.init("tooltip", t, e) };
    o.VERSION = "3.3.6", o.TRANSITION_DURATION = 150, o.DEFAULTS = { animation: !0, placement: "top", selector: !1, template: '<div class="tooltip" role="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover focus", title: "", delay: 0, html: !1, container: !1, viewport: { selector: "body", padding: 0 } }, o.prototype.init = function(e, o, i) { if (this.enabled = !0, this.type = e, this.$element = t(o), this.options = this.getOptions(i), this.$viewport = this.options.viewport && t(t.isFunction(this.options.viewport) ? this.options.viewport.call(this, this.$element) : this.options.viewport.selector || this.options.viewport), this.inState = { click: !1, hover: !1, focus: !1 }, this.$element[0] instanceof document.constructor && !this.options.selector) throw new Error("`selector` option must be specified when initializing " + this.type + " on the window.document object!"); for (var n = this.options.trigger.split(" "), r = n.length; r--;) { var s = n[r]; if ("click" == s) this.$element.on("click." + this.type, this.options.selector, t.proxy(this.toggle, this));
        ...
        return !1 }, o.prototype.leave = function(e) { var o = e instanceof this.constructor ? e : t(e.currentTarget).data("bs." + this.type); return o || (o = new this.constructor(e.currentTarget, this.getDelegateOptions()), t(e.currentTarget).data("bs." + this.type, o)), e instanceof t.Event && (o.inState["focusout" == e.type ? "focus" : "hover"] = !1), o.isInStateTrue() ? void 0 : (clearTimeout(o.timeout), o.hoverState = "out", o.options.delay && o.options.delay.hide ? void(o.timeout = setTimeout(function() { "out" == o.hoverState && o.hide() }, o.options.delay.hide)) : o.hide()) }, o.prototype.show = function() { var e = t.Event("show.bs." + this.type); if (this.hasContent() && this.enabled) { this.$element.trigger(e); var i = t.contains(this.$element[0].ownerDocument.documentElement, this.$element[0]); if (e.isDefaultPrevented() || !i) return; var n = this,
            ...
            this.setContent(), r.attr("id", s), this.$element.attr("aria-describedby", s), this.options.animation && r.addClass("fade"); var a = "function" == typeof this.options.placement ? this.options.placement.call(this, r[0], this.$element[0]) : this.options.placement,
                p = /\s?auto?\s?/i,
                l = p.test(a);
            l && (a = a.replace(p, "") || "top"), r.detach().css({ top: 0, left: 0, display: "block" }).addClass(a).data("bs." + this.type, this), this.options.container ? r.appendTo(this.options.container) : r.insertAfter(this.$element), this.$element.trigger("inserted.bs." + this.type); var h = this.getPosition(),
                d = r[0].offsetWidth,
                c = r[0].offsetHeight; if (l) { var f = a,
                    u = this.getPosition(this.$viewport);
                a = "bottom" == a && h.bottom + c > u.bottom ? "top" : "top" == a && h.top - c < u.top ? "bottom" : "right" == a && h.right + d > u.width ? "left" : "left" == a && h.left - d < u.left ? "right" : a, r.removeClass(f).addClass(a) } var v = this.getCalculatedOffset(a, h, d, c);
            this.applyPlacement(v, a); var g = function() { var t = n.hoverState;
                n.$element.trigger("shown.bs." + n.type), n.hoverState = null, "out" == t && n.leave(n) };
            t.support.transition && this.$tip.hasClass("fade") ? r.one("bsTransitionEnd", g).emulateTransitionEnd(o.TRANSITION_DURATION) : g() } }, o.prototype.applyPlacement = function(e, o) { var i = this.tip(),
            n = i[0].offsetWidth,
            r = i[0].offsetHeight,
            s = parseInt(i.css("margin-top"), 10),
            a = parseInt(i.css("margin-left"), 10);
        isNaN(s) && (s = 0), isNaN(a) && (a = 0), e.top += s, e.left += a, t.offset.setOffset(i[0], t.extend({ using: function(t) { i.css({ top: Math.round(t.top), left: Math.round(t.left) }) } }, e), 0), i.addClass("in"); var p = i[0].offsetWidth,
            l = i[0].offsetHeight; "top" == o && l != r && (e.top = e.top + r - l); var h = this.getViewportAdjustedDelta(o, e, p, l);
        h.left ? e.left += h.left : e.top += h.top; var d = /top|bottom/.test(o),
            c = d ? 2 * h.left - n + p : 2 * h.top - r + l,
            f = d ? "offsetWidth" : "offsetHeight";
        i.offset(e), this.replaceArrow(c, i[0][f], d) }, o.prototype.replaceArrow = function(t, e, o) { this.arrow().css(o ? "left" : "top", 50 * (1 - t / e) + "%").css(o ? "top" : "left", "") }, o.prototype.setContent = function() { var t = this.tip(),
            e = this.getTitle();
        ...
        function i() { "in" != n.hoverState && r.detach(), n.$element.removeAttr("aria-describedby").trigger("hidden.bs." + n.type), e && e() } var n = this,
            r = t(this.$tip),
            s = t.Event("hide.bs." + this.type); return this.$element.trigger(s), s.isDefaultPrevented() ? void 0 : (r.removeClass("in"), t.support.transition && r.hasClass("fade") ? r.one("bsTransitionEnd", i).emulateTransitionEnd(o.TRANSITION_DURATION) : i(), this.hoverState = null, this) }, o.prototype.fixTitle = function() { var t = this.$element;
        ...
        null == n.width && (n = t.extend({}, n, { width: n.right - n.left, height: n.bottom - n.top })); var r = i ? { top: 0, left: 0 } : e.offset(),
            s = { scroll: i ? document.documentElement.scrollTop || document.body.scrollTop : e.scrollTop() },
            a = i ? { width: t(window).width(), height: t(window).height() } : null; return t.extend({}, n, s, a, r) }, o.prototype.getCalculatedOffset = function(t, e, o, i) { return "bottom" == t ? { top: e.top + e.height, left: e.left + e.width / 2 - o / 2 } : "top" == t ? { top: e.top - i, left: e.left + e.width / 2 - o / 2 } : "left" == t ? { top: e.top + e.height / 2 - i / 2, left: e.left - o } : { top: e.top + e.height / 2 - i / 2, left: e.left + e.width } }, o.prototype.getViewportAdjustedDelta = function(t, e, o, i) { var n = { top: 0, left: 0 }; if (!this.$viewport) return n; var r = this.options.viewport && this.options.viewport.padding || 0,
            s = this.getPosition(this.$viewport); if (/right|left/.test(t)) { var a = e.top - r - s.scroll,
                p = e.top + r - s.scroll + i;
            a < s.top ? n.top = s.top - a : p > s.top + s.height && (n.top = s.top + s.height - p) } else { var l = e.left - r,
                h = e.left + r + o;
            l < s.left ? n.left = s.left - l : h > s.right && (n.left = s.left + s.width - h) } return n }, o.prototype.getTitle = function() { var t, e = this.$element,
    ...
    function e(e) { return this.each(function() { var i = t(this),
                n = i.data("bs.popover"),
                r = "object" == typeof e && e;
            (n || !/destroy|hide/.test(e)) && (n || i.data("bs.popover", n = new o(this, r)), "string" == typeof e && n[e]()) }) } var o = function(t, e) { this.init("popover", t, e) }; if (!t.fn.tooltip) throw new Error("Popover requires tooltip.js");
...
! function() {
    ...
    function N(d) { if (Error.captureStackTrace) Error.captureStackTrace(this, N);
        else { var A = Error().stack;
            A && (this.stack = A) }
    ...
    function i(d) { var A, N = [],
            $ = 0; for (A in d) N[$++] = d[A]; return N }

    function o(d, A) { var N;
        d: { for (N in d)
    ...
    function f(d) { if (!Od[d]) { for (var A = 0, N = bd(String(Bd)).split("."), $ = bd(String(d)).split("."), n = Math.max(N.length, $.length), t = 0; 0 == A && n > t; t++) { var r = N[t] || "",
                    a = $[t] || "",
                    i = RegExp("(\\d*)(\\D*)", "g"),
                    o = RegExp("(\\d*)(\\D*)", "g");
                do { var u = i.exec(r) || ["", "", ""],
                        l = o.exec(a) || ["", "", ""]; if (0 == u[0].length && 0 == l[0].length) break;
                    A = e(0 == u[1].length ? 0 : parseInt(u[1], 10), 0 == l[1].length ? 0 : parseInt(l[1], 10)) || e(0 == u[2].length, 0 == l[2].length) || e(u[2], l[2]) } while (0 == A) }
            Od[d] = A >= 0 } }

    function c(A) { var N = document; return d(A) ? N.getElementById(A) : A }

    function s(d, A) { switch (this.a = d, this.l = A.name, this.f = !!A.ba, this.b = A.c, this.j = A.type, this.i = !1, this.b) {
            case Ud:
            case wd:
            case Vd:
            case Hd:
    ...
    function p(d, A) { this.b = d, this.a = {}; for (var N = 0; N < A.length; N++) { var $ = A[N];
            this.a[$.a] = $ } }
    ...
    function S(d, A) { for (var N in d.b) { var $ = Number(N);
            d.f[$] || A.call(d, $, d.b[N]) } }

    function b(d, A) { for (var N = h(d.h()), $ = 0; $ < N.length; $++) { var e = N[$],
                n = e.a; if (m(A, n)) { d.a && delete d.a[e.a]; var t = 11 == e.b || 10 == e.b; if (e.f)
    ...
    function M(d, A) { var N = d.b[A]; if (null == N) return null; if (d.g) { if (!(A in d.a)) { var $ = d.g,
                    e = d.f[A]; if (null != N)
                    if (e.f) { for (var n = [], t = 0; t < N.length; t++) n[t] = $.a(e, N[t]);
                        N = n } else N = $.a(e, N);
                return d.a[A] = N } return d.a[A] } return N }

    function v(d, A, N) { var $ = M(d, A); return d.f[A].f ? $[N || 0] : $ }

    function y(d, A) { var N; if (m(d, A)) N = v(d, A, void 0);
        else d: { if (N = d.f[A], void 0 === N.g) { var $ = N.j; if ($ === Boolean) N.g = !1;
                else if ($ === Number) N.g = 0;
                else { if ($ !== String) { N = new $; break d }
                    N.g = N.i ? "0" : "" } }
            N = N.g }
        return N }
    ...
    function W(d) { var A = Z(d.toString());
        O(d), d.a(A) }
    ...
    function J(d, A, N) { if (0 == v(A, 2) && m(A, 5)) { var $ = y(A, 5); if (0 < $.length) return $ } var $ = y(A, 1),
            e = z(A); return 0 == N ? q($, 0, e, "") : $ in Xd ? (d = Q(d, $, od($)), A = $d(A, d, N), e = dd(e, d, N), q($, N, e, A)) : e }

    function Q(d, A, N) { return "001" == N ? nd(d, "" + A) : nd(d, N) }

    function X(d, A, N) { if (!k(N)) return J(d, A, 1); var $ = y(A, 1),
            e = z(A); if (!($ in Xd)) return e; if (1 == $) { if (null != N && 0 <= vd(Xd[1], N.toUpperCase())) return $ + " " + J(d, A, 2) } else if ($ == ud(d, N)) return J(d, A, 2); var n = nd(d, N),
            t = y(n, 11); return N = "", gd(AA, t) ? N = t : m(n, 17) && (N = y(n, 17)), d = Q(d, $, od($)), e = dd(e, d, 1), A = $d(A, d, 1), 0 < N.length ? N + " " + $ + " " + e + A : q($, 1, e, A) }

    function j(d, A, N) { var $; if (($ = m(A, 5)) && (($ = m(A, 4)) && ($ = y(A, 1), $ = Q(d, $, od($)), $ = !(null != $ && y($, 26))), !$)) { if ($ = y(A, 1), $ = Q(d, $, od($)), null == $) $ = !1;
            else { var e = z(A);
                $ = null != Ad(M($, 19) || [], e) }
            $ = !$ } if ($) return y(A, 5); if (!m(A, 6)) return J(d, A, 2); switch (v(A, 6)) {
            case 1:
                d = J(d, A, 1); break;
            case 5:
                d = X(d, A, N); break;
            case 10:
                d = J(d, A, 1).substring(1); break;
            default:
                $ = od(y(A, 1)); var n; if (N = nd(d, $), null == N ? n = null : (N = y(N, 12), n = 0 == N.length ? null : N = N.replace("~", "")), N = J(d, A, 2), null == n || 0 == n.length) { d = N; break } var t;
                d: { if (e = y(A, 5), e = Y(e, zd), 0 == e.lastIndexOf(n, 0)) try { t = rd(d, hd(d, e.substring(n.length), $, !1)); break d } catch (r) {}
                    t = !1 }
                if (t) { d = N; break } if (t = nd(d, $), $ = z(A), t = Ad(M(t, 19) || [], $), null == t) { d = N; break } if ($ = y(t, 4), e = $.indexOf("$1"), 0 >= e) { d = N; break } if ($ = $.substring(0, e), $ = Y($, zd), 0 == $.length) { d = N; break }
                t = t.clone(), x(t, 4), $ = [t], t = y(A, 1), N = z(A), t in Xd ? (d = Q(d, t, od(t)), e = "", e = Ad($, N), null == e ? e = N : ($ = e.clone(), e = y(e, 4), 0 < e.length && (n = y(d, 12), 0 < n.length ? (e = e.replace(uA, n).replace(lA, "$1"), T($, 4, e)) : x($, 4)), e = Nd(N, $, 2)), d = $d(A, d, 2), d = q(t, 2, e, d)) : d = N } return A = y(A, 5), null != d && 0 < A.length && (t = Y(d, qd), N = Y(A, qd), t != N && (d = A)), d }

    function z(d) { var A = "" + v(d, 2); return m(d, 4) && v(d, 4) ? Array(y(d, 8) + 1).join("0") + A : A }

    function q(d, A, N, $) { switch (A) {
            case 0:
                return "+" + d + N + $;
            case 1:
                return "+" + d + " " + N + $;
    ...
    function Nd(d, A, N, $) { var e = y(A, 2),
            n = new RegExp(v(A, 1)),
            t = y(A, 5),
            r = ""; return 2 == N && null != $ && 0 < $.length && 0 < t.length ? (A = t.replace(fA, $), e = e.replace(oA, A), r = d.replace(n, e)) : (A = y(A, 4), r = 2 == N && null != A && 0 < A.length ? d.replace(n, e.replace(oA, A)) : d.replace(n, e)), 3 == N && (r = r.replace(RegExp("^[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+"), ""), r = r.replace(RegExp("[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]+", "g"), "-")), r }
    ...
    function nd(d, A) { if (null == A) return null;
        A = A.toUpperCase(); var N = d.a[A]; if (null == N) { if (N = jd[A], null == N) return null;
            N = (new U).f(K.h(), N), d.a[A] = N } return N }

    function td(d, A) { return gd(y(A, 3), d) && gd(y(A, 2), d) }

    function rd(d, A) { var N = id(d, A); return ad(d, A, N) }

    function ad(d, A, N) { var $ = y(A, 1),
            e = Q(d, $, N); return null == e || "001" != N && $ != ud(d, N) ? !1 : (d = z(A), -1 != ed(d, e)) }

    function id(d, A) { if (null == A) return null; var N = y(A, 1),
            N = Xd[N]; if (null == N) N = null;
        else if (1 == N.length) N = N[0];
        else d: { for (var $, e = z(A), n = N.length, t = 0; n > t; t++) { $ = N[t]; var r = nd(d, $); if (m(r, 23)) { if (0 == e.search(v(r, 23))) { N = $; break d } } else if (-1 != ed(e, r)) { N = $; break d } }
            N = null }
        return N }
    ...
    function fd(d, A) { var N = z(A),
            $ = y(A, 1); return $ in Xd ? ($ = Q(d, $, od($)), $ = v($, 1), $ = y($, 3), ld($, N)) : 1 }

    function cd(d, A) { var N = d.toString(); if (0 == N.length || "0" == N.charAt(0)) return 0; for (var $, e = N.length, n = 1; 3 >= n && e >= n; ++n)
            if ($ = parseInt(N.substring(0, n), 10), $ in Xd) return A.a(N.substring(n)), $;
        return 0 }

    function sd(d, A, N, $, e) { if (0 == d.length) return 0;
        d = new B(d); var n;
        null != A && (n = v(A, 11)), null == n && (n = "NonMatch"); var t = d.toString(); if (0 == t.length) n = 20;
        else if (NA.test(t)) t = t.replace(NA, ""), O(d), d.a(Z(t)), n = 1;
        else { if (t = new RegExp(n), W(d), n = d.toString(), 0 == n.search(t)) { var t = n.match(t)[0].length,
                    r = n.substring(t).match($A);
                r && null != r[1] && 0 < r[1].length && "0" == Y(r[1], zd) ? n = !1 : (O(d), d.a(n.substring(t)), n = !0) } else n = !1;
            n = n ? 5 : 20 } if ($ && T(e, 6, n), 20 != n) { if (2 >= d.b.length) throw "Phone number too short after IDD"; if (N = cd(d, N), 0 != N) return T(e, 1, N), N; throw "Invalid country calling code" } if (null != A && (n = y(A, 10), t = "" + n, r = d.toString(), 0 == r.lastIndexOf(t, 0))) { var a = new B(r.substring(t.length)),
                r = v(A, 1),
                t = new RegExp(y(r, 2)); if (pd(a, A, null), A = a.toString(), r = y(r, 3), !gd(t, d.toString()) && gd(t, A) || 3 == ld(r, d.toString())) return N.a(A), $ && T(e, 6, 10), T(e, 1, n), n } return T(e, 1, 0), 0 }

    function pd(d, A, N) { var $ = d.toString(),
            e = $.length,
            n = v(A, 15); if (0 != e && null != n && 0 != n.length && (n = new RegExp("^(?:" + n + ")"), e = n.exec($))) { var t, r = RegExp;
            t = v(A, 1), t = y(t, 2), r = new r(t), t = gd(r, $); var a = e.length - 1;
    ...
    function hd(d, A, N, $) { if (null == A) throw "The string supplied did not seem to be a phone number"; if (250 < A.length) throw "The string supplied is too long to be a phone number"; var e = new B,
            n = A.indexOf(";phone-context="); if (n > 0) { var t = n + 15; if ("+" == A.charAt(t)) { var r = A.indexOf(";", t);
                r > 0 ? e.a(A.substring(t, r)) : e.a(A.substring(t)) }
            t = A.indexOf("tel:"), e.a(A.substring(t >= 0 ? t + 4 : 0, n)) } else e.a(V(A)); if (n = e.toString(), t = n.indexOf(";isub="), t > 0 && (O(e), e.a(n.substring(0, t))), !H(e.toString())) throw "The string supplied did not seem to be a phone number"; if (n = e.toString(), !(k(N) || null != n && 0 < n.length && NA.test(n))) throw "Invalid country calling code";
        n = new F, $ && T(n, 5, A);
        d: { if (A = e.toString(), t = A.search(aA), t >= 0 && H(A.substring(0, t)))
                for (var r = A.match(aA), a = r.length, i = 1; a > i; ++i)
                    if (null != r[i] && 0 < r[i].length) { O(e), e.a(A.substring(0, t)), A = r[i]; break d }
            A = "" }
        0 < A.length && T(n, 3, A), t = nd(d, N), A = new B, r = 0, a = e.toString(); try { r = sd(a, t, A, $, n) } catch (o) { if ("Invalid country calling code" != o || !NA.test(a)) throw o; if (a = a.replace(NA, ""), r = sd(a, t, A, $, n), 0 == r) throw o } if (0 != r ? (e = od(r), e != N && (t = Q(d, r, e))) : (W(e), A.a(e.toString()), null != N ? (r = y(t, 10), T(n, 1, r)) : $ && x(n, 6)), 2 > A.b.length) throw "The string supplied is too short to be a phone number"; if (null != t && (d = new B, N = new B(A.toString()), pd(N, t, d), e = N.toString(), t = v(t, 1), t = y(t, 3), 2 != ld(t, e) && (A = N, $ && T(n, 7, d.toString()))), $ = A.toString(), d = $.length, 2 > d) throw "The string supplied is too short to be a phone number"; if (d > 17) throw "The string supplied is too long to be a phone number"; if (1 < $.length && "0" == $.charAt(0)) { for (T(n, 4, !0), d = 1; d < $.length - 1 && "0" == $.charAt(d);) d++;
            1 != d && T(n, 8, d) } return T(n, 2, parseInt($, 10)), n }

    function gd(d, A) { var N = "string" == typeof d ? A.match("^(?:" + d + ")$") : A.match(d); return N && N[0].length == A.length ? !0 : !1 }

    function Cd() { var d = c("phoneNumber").value,
            A = c("defaultCountry").value;
        c("carrierCode").value, new B; try { var N, $ = w.a(); if (!k(A) && 0 < d.length && "+" != d.charAt(0)) throw "Invalid country calling code";
            N = hd($, d, A, !0); var e = 0 == fd($, N); if (e) { var n = rd($, N); if (n) { var t, r, a = id($, N),
                        i = Q($, y(N, 1), a); if (null == i) t = -1;
                    else { var o = z(N);
                        t = ed(o, i) } switch (t) {
                        case 0:
                            r = "FIXED_LINE"; break;
                        case 1:
                            r = "MOBILE"; break;
                        case 2:
                            r = "FIXED_LINE_OR_MOBILE"; break;
                        case 3:
                            r = "TOLL_FREE"; break;
                        case 4:
                            r = "PREMIUM_RATE"; break;
                        case 5:
                            r = "SHARED_COST"; break;
                        case 6:
                            r = "VOIP"; break;
                        case 7:
                            r = "PERSONAL_NUMBER"; break;
                        case 8:
                            r = "PAGER"; break;
                        case 9:
                            r = "UAN"; break;
                        case -1:
                            r = "UNKNOWN" } return { isValidNumber: n, isValidNumberForRegion: ad($, N, A), phoneNumberRegion: id($, N), numberType: r, format: { E164: J($, N, 0), orginal: j($, N, A), national: J($, N, 2), international: J($, N, 1), "out-country-us": X($, N, "US"), "out-country-ch": X($, N, "CH") } } } return "INVALID_PH_N" } switch (fd($, N)) {
                case 1:
                ...
                case 3:
                    return "TOO_LONG";
                default:
                    return "UNKNOWN_TYPE" } } catch (u) { return u } }
    var Sd = this;
    ...
    var md, Md = Array.prototype,
        vd = Md.indexOf ? function(d, A, N) { return Md.indexOf.call(d, A, N) } : function(A, N, $) { if ($ = null == $ ? 0 : 0 > $ ? Math.max(0, A.length + $) : $, d(A)) return d(N) && 1 == N.length ? A.indexOf(N, $) : -1; for (; $ < A.length; $++)
                if ($ in A && A[$] === N) return $;
            return -1 };
    d: { var yd = Sd.navigator; if (yd) { var Ed = yd.userAgent; if (Ed) { md = Ed; break d } }
        md = "" }
    ...
    var Fd = (/\uffff/.test("￿") ? /[\\\"\x00-\x1f\x7f-\uffff]/g : /[\\\"\x00-\x1f\x7f-\xff]/g, 1),
        ...
        Hd = 16,
        Zd = 18;
    C.prototype.clone = function() { var d = new this.constructor; return d != this && (d.b = {}, d.a && (d.a = {}), b(d, this)), d }, R.prototype.b = function(d, A) { return 11 == d.b || 10 == d.b ? this.g(A) : "number" != typeof A || isFinite(A) ? A : A.toString() }, R.prototype.f = function(d, A) { var N = new d.b; return this.i(N, A), N }, R.prototype.a = function(A, N) { if (11 == A.b || 10 == A.b) return N instanceof C ? N : this.f(A.j.prototype.h(), N); if (14 == A.b || !A.i) return N; var $ = A.j; if ($ === String) { if ("number" == typeof N) return String(N) } else if ($ === Number && d(N) && ("Infinity" === N || "-Infinity" === N || "NaN" === N || /^-?[0-9]+$/.test(N))) return Number(N); return N }, A(_, R), _.prototype.g = function(d) { for (var A = h(d.h()), N = {}, $ = 0; $ < A.length; $++) { var e = A[$],
                n = 1 == this.j ? e.l : e.a; if (m(d, e.a))
                if (e.f) { var t = []; for (N[n] = t, n = 0; n < E(d, e.a); n++) t.push(this.b(e, v(d, e.a, n))) } else N[n] = this.b(e, v(d, e.a, void 0)) } return S(d, function(d, A) { N[d] = A }), N }, _.prototype.a = function(d, A) { return 8 == d.b && "number" == typeof A ? Boolean(A) : _.ha.a.call(this, d, A) }, _.prototype.i = function(d, A) { var N, $ = d.h(); for (N in A) { var e, n = A[N],
                r = !/[^0-9]/.test(N); if (e = r ? $.a[parseInt(N, 10)] || null : g($, N))
                if (e.f)
                    for (r = 0; r < n.length; r++) { var a = this.a(e, n[r]);
                        G(d, e.a, a) } else n = this.a(e, n), T(d, e.a, n);
                else r ? (e = d, r = Number(N), e.b[r] = n, e.a && delete e.a[r]) : t("Failed to find field: " + e) } }, B.prototype.b = "", B.prototype.a = function(d, A, N) { if (this.b += d, null != A)
            for (var $ = 1; $ < arguments.length; $++) this.b += arguments[$]; return this }, B.prototype.toString = function() { return this.b };
    var Wd;
    A(L, C);
    var Yd;
    A(P, C);
    ...
    for (var hA; sA.length && (hA = sA.shift());) { var gA;
